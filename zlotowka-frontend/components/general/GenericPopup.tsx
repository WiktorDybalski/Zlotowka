...
export default function GenericPopup({
  ...
  return (
      ...
      >
        ...
        {/* Modal container */}
        <div
            className={`bg-background dark:bg-dark dark:text-background border-[1px] max-w-[350px] overflow-y-auto max-h-[100dvh] custom-scroll lg:max-w-full border-[rgba(38,38,38,0.5)] p-6 lg:px-10 lg:py-10 rounded-[10px] z-10 transition-all duration-200 ease-in-out transform ${
