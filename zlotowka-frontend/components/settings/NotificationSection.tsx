...
export const NotificationsSection: React.FC<NotificationsSectionProps> = ({ notificationsByEmail, setNotificationsByEmail, notificationsByPhone, setNotificationsByPhone }) => (
