...
export default function NavigationLinks({ links, isMobile = false }: NavigationLinksProps) {
  const linkVariants = {
  ...
  return (
      <div className={`flex flex-col ${isMobile ? 'flex-1 gap-y-6 my-6' : 'flex-1 gap-y-6 my-6'}`}>
