...
export default function Home() {
  ...
  return (
      <div className="h-[200vh] flex flex-col justify-center items-center">
        ...
        <button className="border-neutral-900 border-2 px-2 py-3 mt-4" onClick={() => setShowAddTransaction(true)}>Add Transaction</button>
        <button className="border-neutral-900 border-2 px-2 py-3 mt-4" onClick={() => setShowEditTransaction(true)}>Edit Transaction</button>
